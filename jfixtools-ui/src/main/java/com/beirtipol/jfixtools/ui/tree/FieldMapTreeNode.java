...
public class FieldMapTreeNode extends FIXTreeNode {
    ...
    public FieldMapTreeNode(FIXTreeNode parent, DataDictionary dictionary, FieldMap fieldMap, String tag, String name, String description) {
        ...
        if (children == null) {
            ...
            children = fieldMapStream.map(f -> {
                ...
                if (fieldMap.hasGroup(fieldNum)) {
                    ...
                    if (fieldMap.isSetField(integerField)) {
                        for (int count = 1; count <= integerField.getValue(); count++) {
                            try {
                                ...
                                return new FieldMapTreeNode(this, dictionary, group, "" + fieldNum, fieldName, fieldDescription);
                    ...
                    return new StringFieldTreeNode(this, dictionary, fieldNum, fieldName, field.getValue(), fieldDescription);
                }
                return null;
